...
public class BaseService {
	...
	* @return
	...
	public void subscribeMessageSend(String accessToken,String touser,String page,String templateId,Object data) {
		...
		if (json.getInteger("errcode")==40001) {
	...
	* @param openid 用户标识
	 ...
	 */
	public Map<String, Object> createOrder(HttpServletRequest request,String body,String out_trade_no,Integer money,String openid) throws UnsupportedEncodingException {
		//32位随机字符串
		...
		//拼接统一下单接口使用的xml数据
		String xml="<xml>"+"<appid><![CDATA["+Constant.XJ_APPID+"]]></appid>"+"<body><![CDATA["+body+"]]></body>"+
		...
		if (return_code.equals("SUCCESS")) {
			...
			if ("SUCCESS".equals(resultCode)) {
				...
				//拼接小程序段的签名字符串
				String signString="appId="+Constant.XJ_APPID+"&nonceStr="+nonce_str+"&package="+"prepay_id=" + prepay_id+"&signType="+Constant.SIGN_TYPE+
						"&timeStamp="+timeStamp;
				//再次生产签名
