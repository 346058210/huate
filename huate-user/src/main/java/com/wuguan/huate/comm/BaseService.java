...
public class BaseService {
	 ...
	 * @return
	 */
	public void subscribeMessageSend(String accessToken, String touser, String page, String templateId, Object data,String appid,String secret) {
	...
	public static void main(String[] args) {
		String result="{\"errcode\":40001,\"errmsg\":\"invalid credential, access_token is invalid or not latest hints: [FiLBiH3MRa-_uezJa!]\"}";
		JSONObject json = JSONObject.parseObject(result);
		System.out.println(json.getString("errcode"));
		System.out.println("40001".equals(json.getString("errcode")));
	}
