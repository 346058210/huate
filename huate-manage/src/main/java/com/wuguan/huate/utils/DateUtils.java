...
public class DateUtils {
	 ...
	 * @return
	 */
	public static boolean isTheSameDay(String d1, Date d2) {
	 ...
	 * 
	 * @Title: inMiddle
	 * @Description: 判断当前hour 在两个时间之间
	 * @param time1
	 * @param time2
	 * @param date
	 * @return
	 */
	public static boolean inMiddle(String time1, String time2, Date date) {
		boolean bool = false;
		try {
			...
			// c2.setTime(date2);
			// c3.setTime(date);
			// bool=c2.get(Calendar.HOUR_OF_DAY)>=c3.get(Calendar.HOUR_OF_DAY);
			long t2 = format.parse(time2).getTime();
			String format2 = format.format(date);
			long t3 = format.parse(format2).getTime();
			bool = t2 >= t3;
		} catch (Exception e) {
		}
		return bool;
	 ...
	 * 判断时间大小
	 */
	public static boolean inMiddle2(String time2, Date date) {
		boolean bool = false;
		try {
			SimpleDateFormat format = new SimpleDateFormat("yyyy-MM-dd HH:mm");
			long t2 = format.parse(time2).getTime();
			long t3 = date.getTime();
			bool = t2 >= t3;
		} catch (Exception e) {
		}
		return bool;
	...
	* @return
	...
	public static void main(String[] args) throws ParseException {
		long time=getTimeMillis("2020-04-28 19:30")-getTimeMillis("2020-04-28 19:00");
