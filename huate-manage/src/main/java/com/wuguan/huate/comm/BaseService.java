...
public class BaseService {
	 ...
	 */
	// public Map<String, Object> createOrder(HttpServletRequest request,String
	// body,String out_trade_no,Integer money,String openid) throws
	...
	// //拼接统一下单接口使用的xml数据
	// String
	// xml="<xml>"+"<appid><![CDATA["+Constant.XJ_APPID+"]]></appid>"+"<body><![CDATA["+body+"]]></body>"+
	// "<mch_id><![CDATA["+Constant.MCH_ID+"]]></mch_id>"+"<nonce_str><![CDATA["+nonce_str+"]]></nonce_str>"+
	// "<notify_url><![CDATA["+Constant.NOTIFY_URL+"]]></notify_url>"+"<openid><![CDATA["+openid+"]]></openid>"+
	// "<out_trade_no><![CDATA["+out_trade_no+"]]></out_trade_no>"+"<spbill_create_ip><![CDATA["+spbill_create_ip+"]]></spbill_create_ip>"+
	// "<total_fee><![CDATA["+fee+"]]></total_fee>"+"<trade_type><![CDATA["+Constant.TRADE_TYPE+"]]></trade_type>"+"<sign>"+sign+"</sign>"+"</xml>";
	...
	// //拼接小程序段的签名字符串
	// String
	// signString="appId="+Constant.XJ_APPID+"&nonceStr="+nonce_str+"&package="+"prepay_id="
	// + prepay_id+"&signType="+Constant.SIGN_TYPE+
	// "&timeStamp="+timeStamp;
	// //再次生产签名
	// String paySign = PayUtil.getSign(signString, Constant.KEY,
	// "utf-8").toUpperCase();
	...
	// //拼接关闭订单xml
	// String
	// xml="<xml>"+"<appid>"+Constant.XJ_APPID+"</appid>"+"<mch_id>"+Constant.MCH_ID+"</mch_id>"+
	// "<nonce_str>"+nonce_str+"</nonce_str>"+"<out_trade_no>"+orderNo+"</out_trade_no>"+"<sign>"+sign+"</sign>"+"</xml>";
	// String result = HttpClientUtil.httpRequest(Constant.CLOSE_ORDER, "POST",
	// xml);
	// //解析xml
	// Map<String, Object> map = PayUtil.doXMLParse(result);
	// String return_code=(String)map.get("return_code");
	...
	// xml="<xml>"+"<appid>"+Constant.XJ_APPID+"</appid>"+"<mch_id>"+Constant.MCH_ID+"</mch_id>"+
	// "<nonce_str>"+nonce_str+"</nonce_str>"+"<out_trade_no>"+orderNo+"</out_trade_no>"+"<sign>"+sign+"</sign>"+"</xml>";
	// String result = HttpClientUtil.httpRequest(Constant.QUERY_ORDER, "POST",
	// xml);
	// //解析xml
	// Map<String, Object> map = PayUtil.doXMLParse(result);
	// return map;
